 ...
 */
public abstract class BetterFragment extends Fragment implements View.OnClickListener {
    ...
    protected abstract void remplir();

    protected abstract void ajouterListeners();
